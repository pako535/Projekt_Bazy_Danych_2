osoby-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
...
CREATE TABLE `sprzet` (
  ...
  CONSTRAINT `lokal` FOREIGN KEY (`id_lokalizacji`) REFERENCES `lokalizacja` (`id_lokalizacja`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2017-12-05 23:57:44
